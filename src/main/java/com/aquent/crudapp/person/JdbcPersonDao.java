...
public class JdbcPersonDao implements PersonDao {
    ...
    private static final String SQL_UPDATE_PERSON = "UPDATE person SET (first_name, last_name, email_address, street_address, city, state, zip_code, company_id)"
                                                  + " = (:firstName, :lastName, :emailAddress, :streetAddress, :city, :state, :zipCode, :companyId)"
                                                  + " WHERE person_id = :personId";
    private static final String SQL_CREATE_PERSON = "INSERT INTO person (first_name, last_name, email_address, street_address, city, state, zip_code, company_id)"
                                                  + " VALUES (:firstName, :lastName, :emailAddress, :streetAddress, :city, :state, :zipCode, :companyId)";
    ...
    private static final class PersonRowMapper implements RowMapper<Person> {
        ...
        public Person mapRow(ResultSet rs, int rowNum) throws SQLException {
            ...
            person.setCompanyId(rs.getString("company_id"));
            return person;
        }
    }
}
